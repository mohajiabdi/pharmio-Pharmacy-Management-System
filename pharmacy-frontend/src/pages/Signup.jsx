...
export default function Signup() {
  ...
  const canSubmit = useMemo(() => {
    ...
    return true;
  }, [fullName, phone, address, email, password, agree]);
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      // await authApi.signup({ fullName, phone, address, email, password })

      await new Promise((r) => setTimeout(r, 500)); // mock

      // After signup go to login (or dashboard if you auto-login)
      nav("/login");
    } catch (err) {
